...
public class LayoutNode extends GraphicalObject {
	...
	public List<LayoutNode> predecessors = new ArrayList<LayoutNode>();
	public List<LayoutNode> successors = new ArrayList<LayoutNode>();
	public List<LayoutNode> upwardsSuccessors = new ArrayList<LayoutNode>();
	public Node node;
