package net.berndreiss.petrinetsimulator.util;
...
/**
 * Diese Klasse implementiert eine einfache XML Ausgabe für PNML Dateien, die
 * mit WoPeD PNML 1.3.2 kompatibel ist.
 */
public final class PNMLWopedWriter {
	...
	public static void main(final String[] args) throws FileNotFoundException{
		if (args.length > 0) {
			...
			System.out.println("Schreibe in Datei: "
					+ pnmlDatei.getAbsoluteFile());
			pnmlWriter.startXMLDocument();

			pnmlWriter.addTransition("transition1", "Transition A", "200",
					"200");
			pnmlWriter.addTransition("transition2", "Transition B", "200",
					"400");
	 ...
	 */
	public PNMLWopedWriter(final File pnml) {
		super();
	 ...
	 */
	public boolean startXMLDocument() throws FileNotFoundException{
		try {
