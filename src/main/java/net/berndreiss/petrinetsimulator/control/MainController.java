...
import static net.berndreiss.petrinetsimulator.gui.MainFrame.GRAPH_SPLIT_PANE_DEFAULT_RATIO;
import static net.berndreiss.petrinetsimulator.gui.MainFrame.SPLIT_PANE_DEFAULT_RATIO;
...
import net.berndreiss.petrinetsimulator.exceptions.DuplicateIdException;
import net.berndreiss.petrinetsimulator.exceptions.PetrinetException;
import net.berndreiss.petrinetsimulator.gui.GraphStreamPetrinetPanel;
import net.berndreiss.petrinetsimulator.gui.MainFrame;
import net.berndreiss.petrinetsimulator.gui.PetrinetToolbar;
