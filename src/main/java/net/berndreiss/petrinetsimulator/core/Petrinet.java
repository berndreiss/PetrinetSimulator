...
import net.berndreiss.petrinetsimulator.exceptions.InvalidEdgeOperationException;
...
import net.berndreiss.petrinetsimulator.listeners.PetrinetComponentChangedListener;
import net.berndreiss.petrinetsimulator.listeners.PetrinetStateChangedListener;
